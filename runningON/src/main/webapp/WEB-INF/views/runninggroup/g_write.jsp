...
<html>
	...
	<body>
				...
				<form id="post_form" method="POST">
					...
					<div class="title-and-board">
						...
						<select id="board" name="board_idx" required>
							...
							<option value="9">모임 공지</option>
							<option value="10">모임 수다</option>
							<!-- 다른 게시판 옵션 추가 -->
						</select>				
					</div>
					...
					<div class="button-container">
						<button type="submit" onclick="g_post_write_ok(this.form)">작성 완료</button>
						<!--
		...
		<script>
			...
			function g_post_write_ok(f) {
				f.action = "/g_post_write_ok";
				f.submit();
			}
		</script>
	</body>
