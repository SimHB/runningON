...
.button-group {
    ...
    gap: 10px; /* 버튼 간 간격 */
    flex: 1; /* button-group이 가능한 넓은 공간 차지 */
}

.write-button-container {
    display: flex;
    justify-content: flex-end; /* '글쓰기' 버튼을 오른쪽 끝에 배치 */
}
...
<body>
	...
	<header class="navbar">
		<div class="navbar_logo">
			<a href="http://localhost:8080/main"><img
				src="/resources/MJS/images/logow.png" alt="로고"></a>
		</div>
		<div class="navbar_blank"></div>
		<ul class="navbar_link">
			<li><a href="http://localhost:8080">로그아웃</a></li>
			<!-- 로그아웃 링크 -->
		</ul>
	</header>
	...
	<div class="wrap">
		...
		<div class="list_box">
			<button type="button" class="toggle_btn"
				onClick="location.href='/announcement'">공지사항</button>
		</div>
		<!-- 유저정보 메뉴 및 서브 메뉴 -->
		<div class="list_box">
		...
		<div class="list_box">
			...
			<div class="inner_area">
				<ul>
					<li><button class="m_btn1"
							onClick="location.href='/reportedcomment'">신고유저</button></li>
					<li><button class="m_btn1"
							onClick="location.href='/reportedboard'">게시물</button></li>
					<li><button class="m_btn1"
							onClick="location.href='/reporteduser'">유저제재내역</button></li>
